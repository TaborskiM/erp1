...
<div class="menu">
		<ul>
            ...
            <li><a href="modifier.php">Modifier client</a></li>
            <li><a href="affichercpt.php">Afficher les compte</a></li>
            <li><a href="ajoutercpt.php">Ajouter un compte</a></li>
            <li><a href="delete.php">Supprimer un compte</a></li>
            <li><a href="affichemouv.php">Afficher Agencer</a></li>
...
<table border="1" class='table'>
    ...
    <?php foreach($comptes as $compte){?>
        <tr>
            <td><?php echo $compte["NUMCPTE"]; ?></td>
            <td><?php echo $compte["Libelle_CPTE"]; ?></td>
            <td><?php echo $compte["TOT_Debit"]; ?></td>
            <td><?php echo $compte["TOT_Credit"]; ?></td>
            <td><?php echo $compte["Solde"]; ?></td>
            <td><?php echo $compte["CODCLT"]; ?></td>
            <td><?php echo $compte["CODAG"]; ?></td>
        </tr>
    <?php } ?>
</table>
</body>
